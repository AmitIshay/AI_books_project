                ...
                SizedBox(
                  ...
                  child: CarouselSlider.builder(
                    ...
                    itemBuilder: (
                      ...
                      if (iObj.containsKey("is_shared") && iObj["is_shared"] is bool) {
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: () async {
                              ...
                              debugPrint("📤 Button pressed. Current isShared: $isShared, sending: ${!isShared}");
                            ...
                            icon: Icon(
                              isShared ? Icons.link_off : Icons.share,
                            ),
                            label: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold, // אופציונלי – מודגש יותר
                              ),
                            ),
                            style: ElevatedButton.styleFrom(
                              backgroundColor: isShared ? Colors.red : Colors.blue,
